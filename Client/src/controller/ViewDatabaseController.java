...
public class ViewDatabaseController implements Initializable{
	...
	public static ArrayList<Librarian> librarianResult=null;
	...
	public void initialize(URL location, ResourceBundle resources) {
    	...
    	try {
			...
			for(int i =0; i<librarianResult.size();i++)
			{
				if(librarianResult.get(i).getRole().equals("Library Director")) 
				{
					managersResult.add(librarianResult.get(i));
					librarianResult.remove(i);
				}
			}
